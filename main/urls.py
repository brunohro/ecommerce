...
from ecommerce.views import index, ofertas, suplemento, informatica, carrinho, esportes, add_ao_carrinho, remover_produto_carrinho, adm, lancamentos, login, logout, finalizar_compra
